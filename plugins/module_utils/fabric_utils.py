...
def get_fabric_cfg_path():
    fabric_cfg_path = tempfile.mkdtemp()
    core_yaml_path = os.path.join(fabric_cfg_path, 'core.yaml')
    with open(core_yaml_path, 'w') as file:
        file.write(core_yaml)
    return fabric_cfg_path
