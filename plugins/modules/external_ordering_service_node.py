...
description:
    - Import or remove an external Hyperledger Fabric ordering service node by using the IBM Blockchain Platform.
...
def main():
    ...
    try:
        ...
        ordering_service_node = console.get_component_by_display_name(name, 'included')
