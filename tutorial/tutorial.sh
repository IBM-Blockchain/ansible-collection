...
# TODO: ansible-playbook 03-export-organization.yml --extra-vars "@org1-vars.yml"
# TODO: ansible-playbook 04-import-organization.yml --extra-vars "@ordering-org-vars.yml"
ansible-playbook 05-add-organization-to-consortium.yml --extra-vars "@ordering-org-vars.yml"
# TODO: ansible-playbook 06-export-ordering-service.yml --extra-vars "@ordering-org-vars.yml"
# TODO: ansible-playbook 07-import-ordering-service.yml --extra-vars "@org1-vars.yml"
...
# TODO: ansible-playbook 12-export-organization.yml --extra-vars "@org2-vars.yml"
# TODO: ansible-playbook 13-import-organization.yml --extra-vars "@org1-vars.yml"
ansible-playbook 14-add-organization-to-channel.yml --extra-vars "@org1-vars.yml"
# TODO: ansible-playbook 15-import-ordering-service.yml --extra-vars "@org2-vars.yml"
